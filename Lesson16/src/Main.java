...
//        Метод должен возвращать результат деления или выводить сообщение об ошибке и возвращать 0.
        ...
        System.out.println("Safe division              :" + res);



//        Задача 2: Проверка массива
//        Создайте метод getElement(int[] arr, int index), который возвращает элемент массива по индексу. Обработайте ситуацию, когда индекс выходит за границы массива (ArrayIndexOutOfBoundsException). При ошибке возвращайте -1.
//
//        Задача 3: Безопасный ввод числа
//        Создайте метод inputNumber(*Scanner scanner, String message* ),
