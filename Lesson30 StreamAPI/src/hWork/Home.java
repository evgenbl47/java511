...
// Ожидаемый результат: [3, 8, 3, 5]
        System.out.println("Ожидаемый результат: 3, 8, 3, 5");
...
//        List<Integer> numbers = Arrays.asList(1, 2, 3, 4, 5, 6, 2, 1);
// Твоё решение:
// Ожидаемый результат: [1, 2, 3, 4] (остановился на 5)

// Дан список слов. Брать слова пока их длина <= 4 символов.
//        List<String> words = Arrays.asList("cat", "dog", "bird", "elephant", "ant", "cow");
// Твоё решение:
...
//        List<String> words = Arrays.asList("cat", "dog", "ant", "elephant", "cow", "bird");
// Твоё решение:
