...
// let ansfer = prompt("Введите имя");
// alert("Привет, его имя: " + ansfer + "!");
...
// alert("Периметр квадрата со стороной " + sqarePerimeter + ": " + calcSR(sidequare(sqarePerimeter));

// 4. Запросите у пользователя радиус окружности и выведите площадь такой окружности. 
// function calcRound(square){
//     return square = Math.PI * Math.pow(square, 2);
// }

// let sqareRound = +prompt("Введите радиус окружности");
// alert("Площадь окуружности: " + calcRound(5));
